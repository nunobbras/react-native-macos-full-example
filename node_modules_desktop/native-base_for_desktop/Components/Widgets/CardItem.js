    ...
    renderChildren() {
        ...
        if(!this.thumbnailPresent() && !this.iconPresent()) {
            ...
            if(!Array.isArray(this.props.children)) {
                newChildren.push(
                    <View key="1" style={{justifyContent: 'flex-start'}}>
                ...
                newChildren.push(
                    <View key="2"  style={ this.notePresent() ? this.getRightStyle().right : this.squareThumbs() ? this.getRightStyle().right3 : this.getRightStyle().right2 }>

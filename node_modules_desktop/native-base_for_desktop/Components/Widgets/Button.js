    ...
    renderChildren() {
        ...
        if(typeof this.props.children == "string") {
            ...
            if(this.props.iconRight) {
                newChildren.push(<Text key="1" style={this.getTextStyle()}>{childrenArray[0]}</Text>);
                newChildren.push(<Text key="2" >{React.cloneElement(iconElement[0], this.getIconProps(iconElement[0]))}</Text>);
            }
            
            else if(this.props.iconLeft || iconElement) {
                newChildren.push(<Text key="3" >{React.cloneElement(iconElement[0], this.getIconProps(iconElement[0]))}</Text>);
                newChildren.push(<Text key="4" style={this.getTextStyle()}>{childrenArray[0]}</Text>);
            }
